...
class TestRAGSystemIntegration:
    ...
    def test_initialization(self, mock_session, mock_processor, mock_ai, mock_vector, mock_config):
        """Test RAG system initialization"""
        rag = RAGSystem(mock_config)
        
        # Verify components were initialized
        mock_processor.assert_called_once_with(mock_config.CHUNK_SIZE, mock_config.CHUNK_OVERLAP)
        mock_vector.assert_called_once_with(mock_config.CHROMA_PATH, mock_config.EMBEDDING_MODEL, mock_config.MAX_RESULTS)
        mock_ai.assert_called_once_with(mock_config.ANTHROPIC_API_KEY, mock_config.ANTHROPIC_MODEL)
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_content_question(self, mock_session_class, mock_processor_class, 
                                   mock_ai_class, mock_vector_class, mock_config):
        ...
        mock_vector.search.return_value = SearchResults(
            documents=["Prompt caching retains processing results between invocations."],
            metadata=[{"course_title": "Building Towards Computer Use", "lesson_number": 5}],
            distances=[0.1],
            error=None
        )
        ...
        # Setup AI response
        mock_ai.generate_response.return_value = "Prompt caching is a technique that retains processing results."
        
        # Create RAG system and query
        rag = RAGSystem(mock_config)
        response, sources = rag.query("What is prompt caching?", session_id="test-session")
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_outline_question(self, mock_session_class, mock_processor_class,
                                   mock_ai_class, mock_vector_class, mock_config):
        ...
        # Setup AI response
        mock_ai.generate_response.return_value = "Course outline: Introduction, Getting Started..."
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_with_tool_execution(self, mock_session_class, mock_processor_class,
                                      mock_ai_class, mock_vector_class, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_without_session(self, mock_session_class, mock_processor_class,
                                  mock_ai_class, mock_vector_class, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_with_error_in_search(self, mock_session_class, mock_processor_class,
                                       mock_ai_class, mock_vector_class, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_add_course_document(self, mock_session_class, mock_processor_class,
                                mock_ai_class, mock_vector_class, mock_exists, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_add_course_folder(self, mock_session_class, mock_processor_class,
                              mock_ai_class, mock_vector_class, mock_exists,
                              mock_isfile, mock_listdir, mock_config):
        ...
        mock_chunks1 = [CourseChunk(content="C1", course_title="Course 1", chunk_index=0)]
        mock_chunks2 = [CourseChunk(content="C2", course_title="Course 2", chunk_index=0)]
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_source_tracking(self, mock_session_class, mock_processor_class,
                            mock_ai_class, mock_vector_class, mock_config):
